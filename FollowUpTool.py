...
class CallDetailsApp:
    ...
    def close_current_tab(self):
        ...
        if current_tab_index >= 3:
            ...
            if current_tab_index != 3:
                ...
                )  # adjust for fixed tabs (0-2 (all notes 0, fups 1, clients info 2) )

                if 0 <= adjusted_index < len(self.entry_tabs):

                    self.entry_tabs.pop(adjusted_index)

                if not self.entry_tabs:  # ensure at least one tab remains
    ...
    def check_previous_cm_ref(self, cm_ref):
        ...
        if matches:
            ...
            popup.transient(self.root)  # keep on top
    ...
    def create_notes_tab(self):
        ...
        self.copy_button = ttk.Button(
            ...
            state=tk.DISABLED,  # Disable the button by default
    ...
    def delete_contact(self, tree, window):
        ...
        if not selected:
            ...
            # Re-enable the Delete Contact button after the process is done
    ...
    def view_contacts(self):
        ...
        # Disable the View Contact button
        ...
        contacts_window.transient(self.root)  # Keep on top

        contacts_window.grab_set()  # Make modal

        # Re-enable the View Contact button when the window is closed
    ...
    def add_quick_note(self, form):
        ...
        if note:
            ...
            # Check if the quick note already exists
    ...
    def view_quick_notes(self):
        ...
        # Disable the View Quick Notes button
        ...
        quick_window.transient(self.root)  # Keep on top

        quick_window.grab_set()  # Make modal

        # Re-enable the View Quick Notes button when the window is closed
    ...
    def delete_quick_note(self, listbox, window):
        ...
        # Disable the Delete Quick Note button
        ...
        if selected:
            ...
            self.quick_notes.pop(index)  # remove from self.quick_notes

            listbox.delete(index)  # remove from listbox

            self.save_json(QUICK_NOTES_FILE, self.quick_notes)  # save updated list JSON
        ...
        # Re-enable the Delete Quick Note button after the process is done
    ...
    def generate_note(self, form):
        ...
        # Add submission methods if they are valid
    ...
    def submit_note(self, form):
        ...
        # Disable the Submit button for the current form
        ...
        if errors:
            ...
            # Enable the Submit button for the current form
    ...
    def get_tags(self, form=None):
        ...
        # Disable the Submit button if form is provided
        ...
        tags_window.attributes("-topmost", True)  # Make the window always on top

        tags_window.grab_set()  # Make the window modal
        ...
        # Re-enable the Submit button if form is provided
        ...
        if selected:
            ...
            for note in self.notes:
                ...
                if str(note["date"]) == str(item[0]) and str(note["cm_ref"]) == str(
                    ...
                    # Re-select the item based on its values
    ...
    def remove_tags_from_note(self):
        ...
        # Disable the Remove Tags button
        ...
        if selected:
            ...
            for note in self.notes:
                ...
                if str(note["date"]) == str(item[0]) and str(note["cm_ref"]) == str(
                    ...
                    tags_window.grab_set()  # Make the window moda

                    # Re-enable the Remove Tags button when the window is closed
    ...
    def edit_tags(self):
        ...
        # Re-enable the Edit Tag button when the window is closed
    ...
    def add_tag(self, listbox):
        ...
        dialog_window.attributes("-topmost", True)  # Make the window always on top

        dialog_window.grab_set()  # Make the window modal

 

        # Re-enable the Add Tag button when the window is closed
    ...
    def show_commented_notes(self):
        ...
        comments_window.transient(self.root)  # Keep on top

        comments_window.grab_set()  # Make modal
            ...
            if new_comment is not None:
                ...
                for note in self.notes:
                    ...
                    if str(note["date"]) == str(item[0]) and str(note["cm_ref"]) == str(
                        ...
                        window.transient(self.root)  # Keep on top
    ...
    def edit_follow_up_date(self):
        ...
        if selected:
            ...
            date_window.transient(self.root)  # Keep on top

            date_window.grab_set()  # Make modal

            # Re-enable the Edit Date button when the window is closed
